...
#define ENABLE_DEBUG    0   // SC : Disable printf debug to reduce code size
...
// SC : Exclude this for size optimisation (makes a big difference with no printf being pulled into build)
