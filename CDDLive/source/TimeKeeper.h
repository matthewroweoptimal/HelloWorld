...
typedef enum	{
//	event_timer_flashwrite_start			= 0x00000001,	//think this might be reserved in freeRTOS?
	event_timer_flashwrite_start			= 0x00000002,
	event_timer_flashwrite_expired			= 0x00000004,
	event_timer_amp_temp_update  			= 0x00000008,
	event_timer_subscription_Voicing1		= 0x00000010,
	event_timer_subscription_Voicing2		= 0x00000020,
	event_timer_subscription_Network1		= 0x00000040,	//	Leave space for 10 network ports
	event_timer_subscription_Network2		= 0x00000080,
