 ...
 *
 * This software is copyright (c) 2009 Audinate Pty Ltd and/or its licensors
 *
...
typedef struct
{
	...
	char data[DANTE_CLOCK_GRANDMASTER_UUID_LENGTH];
...
{
		/** the denate instance's device id */
