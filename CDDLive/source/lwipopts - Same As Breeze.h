 ...
 */
#ifndef MEM_SIZE
#define MEM_SIZE                (32*1024) // Breeze was (32*1024) - actually not used since we do alloc from FreeRTOS heap
#endif
...
#define MEMP_NUM_UDP_PCB        8 // Breeze was 8
#endif
...
//#define MEMP_NUM_SYS_TIMEOUT    12  // Increased from 10 if AUTO-IP configured
#endif
